...
This application uses jQuery to build a Star Wars-themed word-guess game.

## Links

[Do or do not. There is no try.](https://lauracole1900.github.io/jedi-word-guess/)
...
Star Wars belongs to LucasFilm and Disney. I make no money from this.
...
[![License badge](https://img.shields.io/badge/license-MIT-121b26)](./LICENSE) [![Open in Visual Studio Code](https://open.vscode.dev/badges/open-in-vscode.svg)](https://open.vscode.dev/LauraCole1900/jedi-word-guess)